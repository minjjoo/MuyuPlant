    ...
    <div>
      ...
      <section style={{ padding: isMobile ? "3rem 1.5rem 4rem" : "6rem 5rem 8rem", background: "#fff" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <h2 style={{ fontSize: isMobile ? "1.4rem" : "1.8rem", fontWeight: 700, color: "#111827", margin: "0 0 1rem" }}>
          ...
          <p style={{ fontSize: "0.95rem", color: "#6b7280", lineHeight: 2, marginBottom: "3.5rem", maxWidth: "100%" }}>
            {tab.desc.split('. ').map((s, i, arr) => (
