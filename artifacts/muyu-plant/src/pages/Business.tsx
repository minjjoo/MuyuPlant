...
export default function Business() {
  ...
  return (
    <div>
      ...
      {/* 탭 */}
      <div style={{ background: "#fff", position: "sticky", top: "88px", zIndex: 50 }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "0 5rem", display: "flex", borderBottom: "1px solid #e5e7eb" }}>
          {TABS.map(({ id, ko }) => (
            <button
              key={id}
