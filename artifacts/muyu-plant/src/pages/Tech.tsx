    ...
    <div>
      ...
      <section style={{ padding: "5rem 3rem 6rem", background: "#fff" }}>
        <div style={{ maxWidth: "1060px", margin: "0 auto" }}>
          <div style={{ background: "#f9fafb", borderRadius: "8px", padding: "1.8rem 2rem", marginBottom: "3rem", border: "1px solid #e5e7eb" }}>
            <p style={{ margin: 0, fontSize: "0.93rem", lineHeight: 2, color: "#374151" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(310px, 1fr))", gap: "1.5rem" }}>
            {techAreas.map(({ title, icon, items, color }) => (
              <div key={title} style={{ background: "#f9fafb", borderRadius: "8px", padding: "1.8rem", border: "1px solid #e5e7eb", borderTop: `3px solid ${color}` }}>
