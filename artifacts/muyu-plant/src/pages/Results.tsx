    ...
    <div>
      ...
      <section style={{ padding: "6rem 5rem 8rem", background: "#fff" }}>
        <div style={{ maxWidth: "1200px", margin: "0 auto" }}>
          ...
          <h2 style={{ fontSize: "1.8rem", fontWeight: 700, color: "#111827", margin: "0 0 2.5rem" }}>주요 프로젝트</h2>

          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "3.5rem", marginBottom: "10rem" }}>
            {projectGallery.map(({ img, title }, i) => (
              <div key={i} style={{ overflow: "hidden" }}>
                ...
                <div style={{ padding: "0.6rem 0 0" }}>
                  <div style={{ fontSize: "0.74rem", fontWeight: 600, color: "#111827", lineHeight: 1.4 }}>{title}</div>
                </div>
              </div>
            ))}
          </div>
          ...
          <h2 style={{ fontSize: "1.8rem", fontWeight: 700, color: "#111827", margin: "0 0 1.5rem" }}>납품 실적</h2>
